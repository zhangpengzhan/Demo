package net.majorkernelpanic.streaming.util;
...
public class ThreadPoolUtils {
    ...
    public static ThreadPoolUtils getInstance(){
        if (threadPoolUtils == null){
            synchronized (ThreadPoolUtils.class){
                if (threadPoolUtils ==null){
                    threadPoolUtils = new ThreadPoolUtils(Type.CachedThread, 4);
                }
            }
        }
    ...
    private ThreadPoolExecutor scheduleExec;
